const nutritionorderValidateFunction = require("../../stu3/js/NutritionOrder");

describe("NutritionOrder", () => {
	 test("validate NutritionOrder-cardiacdiet.json", () => {
		 const nutritionorderExample1 = require("../stu3-resources/NutritionOrder-cardiacdiet.json");
		 expect(nutritionorderValidateFunction(nutritionorderExample1)).toBe(true);
	 });

	 test("validate NutritionOrder-diabeticdiet.json", () => {
		 const nutritionorderExample2 = require("../stu3-resources/NutritionOrder-diabeticdiet.json");
	 ...
	 test("validate NutritionOrder-diabeticsupplement.json", () => {
		 const nutritionorderExample3 = require("../stu3-resources/NutritionOrder-diabeticsupplement.json");
		 expect(nutritionorderValidateFunction(nutritionorderExample3)).toBe(true);
	 });

	 test("validate NutritionOrder-energysupplement.json", () => {
		 const nutritionorderExample4 = require("../stu3-resources/NutritionOrder-energysupplement.json");
		 expect(nutritionorderValidateFunction(nutritionorderExample4)).toBe(true);
	 });

	 test("validate NutritionOrder-enteralbolus.json", () => {
		 const nutritionorderExample5 = require("../stu3-resources/NutritionOrder-enteralbolus.json");
	 ...
	 test("validate NutritionOrder-enteralcontinuous.json", () => {
		 const nutritionorderExample6 = require("../stu3-resources/NutritionOrder-enteralcontinuous.json");
	 ...
	 test("validate NutritionOrder-fiberrestricteddiet.json", () => {
		 const nutritionorderExample7 = require("../stu3-resources/NutritionOrder-fiberrestricteddiet.json");
		 expect(nutritionorderValidateFunction(nutritionorderExample7)).toBe(true);
	 });

	 test("validate NutritionOrder-infantenteral.json", () => {
		 const nutritionorderExample8 = require("../stu3-resources/NutritionOrder-infantenteral.json");
	 ...
	 test("validate NutritionOrder-proteinsupplement.json", () => {
		 const nutritionorderExample9 = require("../stu3-resources/NutritionOrder-proteinsupplement.json");

const medicationrequestValidateFunction = require("../../r4/js/MedicationRequest");

describe("MedicationRequest", () => {
	 test("validate MedicationRequest-medrx002.json", () => {
		 const medicationrequestExample1 = require("../r4-resources/MedicationRequest-medrx002.json");
	 ...
	 test("validate MedicationRequest-medrx0308.json", () => {
		 const medicationrequestExample2 = require("../r4-resources/MedicationRequest-medrx0308.json");
	 ...
	 test("validate MedicationRequest-medrx0312.json", () => {
		 const medicationrequestExample3 = require("../r4-resources/MedicationRequest-medrx0312.json");
	 ...
	 test("validate MedicationRequest-medrx0313.json", () => {
		 const medicationrequestExample4 = require("../r4-resources/MedicationRequest-medrx0313.json");
	 ...
	 test("validate MedicationRequest-medrx0314.json", () => {
		 const medicationrequestExample5 = require("../r4-resources/MedicationRequest-medrx0314.json");
	 ...
	 test("validate MedicationRequest-medrx0320.json", () => {
		 const medicationrequestExample6 = require("../r4-resources/MedicationRequest-medrx0320.json");
	 ...
	 test("validate MedicationRequest-medrx0324.json", () => {
		 const medicationrequestExample7 = require("../r4-resources/MedicationRequest-medrx0324.json");
	 ...
	 test("validate MedicationRequest-medrx0325.json", () => {
		 const medicationrequestExample8 = require("../r4-resources/MedicationRequest-medrx0325.json");
	 ...
	 test("validate MedicationRequest-medrx0326.json", () => {
		 const medicationrequestExample9 = require("../r4-resources/MedicationRequest-medrx0326.json");
	 ...
	 test("validate MedicationRequest-medrx0327.json", () => {
		 const medicationrequestExample10 = require("../r4-resources/MedicationRequest-medrx0327.json");
	 ...
	 test("validate MedicationRequest-medrx0334.json", () => {
		 const medicationrequestExample11 = require("../r4-resources/MedicationRequest-medrx0334.json");
	 ...
	 test("validate MedicationRequest-medrx0335.json", () => {
		 const medicationrequestExample12 = require("../r4-resources/MedicationRequest-medrx0335.json");

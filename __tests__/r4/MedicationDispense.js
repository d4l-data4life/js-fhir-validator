const medicationdispenseValidateFunction = require("../../r4/js/MedicationDispense");

describe("MedicationDispense", () => {
	 test("validate MedicationDispense-meddisp0307.json", () => {
		 const medicationdispenseExample1 = require("../r4-resources/MedicationDispense-meddisp0307.json");
	 ...
	 test("validate MedicationDispense-meddisp0311.json", () => {
		 const medicationdispenseExample2 = require("../r4-resources/MedicationDispense-meddisp0311.json");
	 ...
	 test("validate MedicationDispense-meddisp0316.json", () => {
		 const medicationdispenseExample3 = require("../r4-resources/MedicationDispense-meddisp0316.json");
	 ...
	 test("validate MedicationDispense-meddisp0318.json", () => {
		 const medicationdispenseExample4 = require("../r4-resources/MedicationDispense-meddisp0318.json");
	 ...
	 test("validate MedicationDispense-meddisp0321.json", () => {
		 const medicationdispenseExample5 = require("../r4-resources/MedicationDispense-meddisp0321.json");
	 ...
	 test("validate MedicationDispense-meddisp0322.json", () => {
		 const medicationdispenseExample6 = require("../r4-resources/MedicationDispense-meddisp0322.json");
	 ...
	 test("validate MedicationDispense-meddisp0324.json", () => {
		 const medicationdispenseExample7 = require("../r4-resources/MedicationDispense-meddisp0324.json");
	 ...
	 test("validate MedicationDispense-meddisp0325.json", () => {
		 const medicationdispenseExample8 = require("../r4-resources/MedicationDispense-meddisp0325.json");
	 ...
	 test("validate MedicationDispense-meddisp0326.json", () => {
		 const medicationdispenseExample9 = require("../r4-resources/MedicationDispense-meddisp0326.json");
	 ...
	 test("validate MedicationDispense-meddisp0327.json", () => {
		 const medicationdispenseExample10 = require("../r4-resources/MedicationDispense-meddisp0327.json");
	 ...
	 test("validate MedicationDispense-meddisp0328.json", () => {
		 const medicationdispenseExample11 = require("../r4-resources/MedicationDispense-meddisp0328.json");

const subscriptionValidateFunction = require("../../r4/js/Subscription");

describe("Subscription", () => {
	 test("validate Subscription-example-error.json", () => {
		 const subscriptionExample1 = require("../r4-resources/Subscription-example-error.json");
		 expect(subscriptionValidateFunction(subscriptionExample1)).toBe(true);
	 });

	 test("validate Subscription-example.json", () => {
		 const subscriptionExample2 = require("../r4-resources/Subscription-example.json");

const compartmentdefinitionValidateFunction = require("../../r4/js/CompartmentDefinition");

describe("CompartmentDefinition", () => {
	 test("validate CompartmentDefinition-device.json", () => {
		 const compartmentdefinitionExample1 = require("../r4-resources/CompartmentDefinition-device.json");
	 ...
	 test("validate CompartmentDefinition-encounter.json", () => {
		 const compartmentdefinitionExample2 = require("../r4-resources/CompartmentDefinition-encounter.json");
	 ...
	 test("validate CompartmentDefinition-example.json", () => {
		 const compartmentdefinitionExample3 = require("../r4-resources/CompartmentDefinition-example.json");
	 ...
	 test("validate CompartmentDefinition-patient.json", () => {
		 const compartmentdefinitionExample4 = require("../r4-resources/CompartmentDefinition-patient.json");
	 ...
	 test("validate CompartmentDefinition-practitioner.json", () => {
		 const compartmentdefinitionExample5 = require("../r4-resources/CompartmentDefinition-practitioner.json");
	 ...
	 test("validate CompartmentDefinition-relatedPerson.json", () => {
		 const compartmentdefinitionExample6 = require("../r4-resources/CompartmentDefinition-relatedPerson.json");

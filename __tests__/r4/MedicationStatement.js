const medicationstatementValidateFunction = require("../../r4/js/MedicationStatement");

describe("MedicationStatement", () => {
	 test("validate MedicationStatement-example003.json", () => {
		 const medicationstatementExample1 = require("../r4-resources/MedicationStatement-example003.json");
	 ...
	 test("validate MedicationStatement-example004.json", () => {
		 const medicationstatementExample2 = require("../r4-resources/MedicationStatement-example004.json");
	 ...
	 test("validate MedicationStatement-example005.json", () => {
		 const medicationstatementExample3 = require("../r4-resources/MedicationStatement-example005.json");
	 ...
	 test("validate MedicationStatement-example006.json", () => {
		 const medicationstatementExample4 = require("../r4-resources/MedicationStatement-example006.json");
